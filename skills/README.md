...
| invoice-merge | 发票 PDF 合并 | **v0.14 多步**：搜含「发票」PDF → 合并为汇总文件 | 📄 | 文档处理 | community | 1.0.0 | https://raw.githubusercontent.com/maqiul/DeskPilot/main/skills/screenshots/invoice-merge.png | 4.6 | 0 |
| excel-rollup | Excel 周报汇总 | **v0.14 多步**：搜本周 xlsx → 汇总 → 统计行数 | 📊 | 办公自动化 | community | 1.0.0 | https://raw.githubusercontent.com/maqiul/DeskPilot/main/skills/screenshots/excel-rollup.png | 4.4 | 0 |
